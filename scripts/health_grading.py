...
# Load annual calculated dataset
df = pd.read_csv("data/calculated_financial_dataset.csv")

print("Annual calculated dataset loaded.")
...
# Save health dataset only
df.to_csv("data/financial_dataset_with_health.csv", index=False)

print("Health grading completed.")
print("File saved as: data/financial_dataset_with_health.csv")
